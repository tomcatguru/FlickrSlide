...
final class URLBuilder<T: URLBuildableType> {
    ...
    @discardableResult func withScheme(_ scheme: String) -> URLBuilder<T> {
        self.isHttps = false
        self.scheme = scheme
        return self
    }

    @discardableResult func withHttp() -> URLBuilder<T> {
        self.isHttps = false
        return self
    }

    @discardableResult func withHost(_ host: String) -> URLBuilder<T> {
        self.host = host
        return self
    }

    @discardableResult func withPath(_ path: String) -> URLBuilder<T> {
        self.path = path
        return self
    }

    @discardableResult func withParam(_ key: String, _ value: String) -> URLBuilder<T> {
        self.keyValues[key] = value
        return self
    }

    @discardableResult func withParams(_ keyValues: [String: String]) -> URLBuilder<T> {
